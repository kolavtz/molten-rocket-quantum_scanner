...
def format_cbom_entry_row(entry) -> Dict[str, Any]:
    ...
    asset_obj = getattr(entry, "asset", None)
    return {
        "id": entry.id,
        "scan_id": entry.scan_id,
        "asset_id": entry.asset_id,
        "asset_name": getattr(asset_obj, "target", None) if asset_obj is not None else None,
        "algorithm_name": entry.algorithm_name or "",
        "category": entry.category or "",
        "asset_type": entry.asset_type or "",
        "element_name": entry.element_name or "",
        "primitive": entry.primitive or "",
        "mode": entry.mode or "",
        "crypto_functions": entry.crypto_functions or "",
        "classical_security_level": entry.classical_security_level,
        "oid": entry.oid or "",
        "element_list": entry.element_list or "",
        "key_id": entry.key_id or "",
        "key_state": entry.key_state or "",
        "key_size": entry.key_size,
        "key_creation_date": format_datetime(getattr(entry, "key_creation_date", None)),
        "key_activation_date": format_datetime(getattr(entry, "key_activation_date", None)),
        "protocol_name": entry.protocol_name or "",
        "protocol_version_name": entry.protocol_version_name or "",
        "cipher_suites": entry.cipher_suites or "",
        "subject_name": entry.subject_name or "",
        "issuer_name": entry.issuer_name or "",
        "not_valid_before": format_datetime(getattr(entry, "not_valid_before", None)),
        "not_valid_after": format_datetime(getattr(entry, "not_valid_after", None)),
        "signature_algorithm_reference": entry.signature_algorithm_reference or "",
        "subject_public_key_reference": entry.subject_public_key_reference or "",
        "certificate_format": entry.certificate_format or "",
        "certificate_extension": entry.certificate_extension or "",
