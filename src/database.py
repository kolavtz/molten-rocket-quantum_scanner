...
def init_db() -> bool:
    ...
    try:
        ...
        for alter_cmd in [
            ...
            "ALTER TABLE scans ADD COLUMN IF NOT EXISTS add_to_inventory BOOLEAN DEFAULT FALSE",
            ...
            "ALTER TABLE certificates ADD COLUMN IF NOT EXISTS certificate_details LONGTEXT",
            ...
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS asset_type VARCHAR(50)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS element_name VARCHAR(255)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS primitive VARCHAR(100)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS mode VARCHAR(100)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS crypto_functions LONGTEXT",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS classical_security_level INT",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS oid VARCHAR(255)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS element_list LONGTEXT",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS key_id VARCHAR(255)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS key_state VARCHAR(50)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS key_size INT",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS key_creation_date DATETIME",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS key_activation_date DATETIME",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS protocol_name VARCHAR(100)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS protocol_version_name VARCHAR(50)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS cipher_suites LONGTEXT",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS subject_name VARCHAR(500)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS issuer_name VARCHAR(500)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS not_valid_before DATETIME",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS not_valid_after DATETIME",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS signature_algorithm_reference VARCHAR(255)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS subject_public_key_reference VARCHAR(255)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS certificate_format VARCHAR(100)",
            "ALTER TABLE cbom_entries ADD COLUMN IF NOT EXISTS certificate_extension VARCHAR(32)",
        ...
        for table_name, wanted_columns in {
            ...
            "certificates": {
                ...
                "public_key_type": "VARCHAR(100) NULL",
                "public_key_pem": "LONGTEXT NULL",
                "certificate_details": "LONGTEXT NULL",
                "signature_algorithm": "VARCHAR(100) NULL",
                "ca_name": "VARCHAR(255) NULL",
                "san_domains": "LONGTEXT NULL",
                "cert_chain_length": "INT NULL",
            ...
            "cbom_entries": {
                ...
                "primitive": "VARCHAR(100) NULL",
                "mode": "VARCHAR(100) NULL",
                "crypto_functions": "LONGTEXT NULL",
                "classical_security_level": "INT NULL",
                "oid": "VARCHAR(255) NULL",
                "element_list": "LONGTEXT NULL",
                "key_id": "VARCHAR(255) NULL",
                "key_state": "VARCHAR(50) NULL",
                "key_size": "INT NULL",
                "key_creation_date": "DATETIME NULL",
                "key_activation_date": "DATETIME NULL",
                "protocol_name": "VARCHAR(100) NULL",
                "protocol_version_name": "VARCHAR(50) NULL",
                "cipher_suites": "LONGTEXT NULL",
                "subject_name": "VARCHAR(500) NULL",
                "issuer_name": "VARCHAR(500) NULL",
                "not_valid_before": "DATETIME NULL",
                "not_valid_after": "DATETIME NULL",
                "signature_algorithm_reference": "VARCHAR(255) NULL",
                "subject_public_key_reference": "VARCHAR(255) NULL",
                "certificate_format": "VARCHAR(100) NULL",
                "certificate_extension": "VARCHAR(32) NULL",
            },
            "compliance_scores": {
                "score_type": "VARCHAR(50) NULL",
                "is_deleted": "BOOLEAN DEFAULT FALSE",
