...
CREATE TABLE IF NOT EXISTS cbom_entries (
    ...
    mode                    VARCHAR(100),
    crypto_functions        LONGTEXT,
    classical_security_level INT,
    oid                     VARCHAR(255),
    element_list            LONGTEXT,
    key_id                  VARCHAR(255),
    key_state               VARCHAR(50),
    key_size                INT,
    key_creation_date       DATETIME,
    key_activation_date     DATETIME,
    protocol_name           VARCHAR(100),
    protocol_version_name   VARCHAR(50),
    cipher_suites           LONGTEXT,
    subject_name            VARCHAR(500),
    issuer_name             VARCHAR(500),
    not_valid_before        DATETIME,
    not_valid_after         DATETIME,
    signature_algorithm_reference VARCHAR(255),
    subject_public_key_reference VARCHAR(255),
    certificate_format      VARCHAR(100),
    certificate_extension   VARCHAR(32),
    key_length              INT,
    ...
    INDEX idx_asset_id (asset_id),
    INDEX idx_algorithm_name (algorithm_name),
    INDEX idx_cbom_asset_type (asset_type),
    INDEX idx_cbom_oid (oid),
